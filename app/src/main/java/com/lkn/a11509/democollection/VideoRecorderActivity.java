...
import com.lkn.a11509.democollection.Widget.SendView;
import com.lkn.a11509.democollection.Widget.VideoProgressBar;
...
//        view = (TextView) findViewById(R.id.view);
    ...
    private View.OnClickListener selectClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(VideoRecorderActivity.this, "文件已保存至：" + path, Toast.LENGTH_SHORT).show();
            send.stopAnim();
            recordLayout.setVisibility(View.VISIBLE);
        }
    };
