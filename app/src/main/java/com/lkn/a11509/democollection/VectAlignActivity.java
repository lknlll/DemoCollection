...
public class VectAlignActivity extends BaseActivity {

    @BindView(R.id.morph_id)
    View morphId;
    ...
    protected void setUpContentView() {
        setContentView(R.layout.activity_vect_align);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.vect_align_menu, menu);
        return true;
    }
    ...
    private void swapView(View newView){
        View toRemove = baseView.findViewById(R.id.morph_id);
        baseView.removeView(toRemove);
        newView.setId(R.id.morph_id);
        baseView.addView(newView, toRemove.getLayoutParams());
    }
